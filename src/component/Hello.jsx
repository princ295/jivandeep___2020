                ...
                <form onSubmit={e => onSubmit(e)}>
                    ...
                    <div className="row">
                      <div className="col-lg-4">
                        <div className="form-group">
                          ...
                          <input type="text" id="firstname" name="firstname" className="form-control" placeholder="Username" defaultValue="lucky.jesse"/>
                        </div>
                      </div>
                      <div className="col-lg-4">
                        <div className="form-group">
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-4">
                            <div className="form-group">
                              ...
                              placeholder="Last name" defaultValue="Jesse" />
                            </div>
                          </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6">
                        <div className="form-group">
                          ...
                          <input type="number" id="alternateNumber" name="alternateNumber"
                           className="form-control" placeholder="Postal code"/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-md-12">
                        <div className="form-group">
                          ...
                          <input id="address" name="address" className="form-control" placeholder="Home Address"
                           defaultValue="Bld Mihail Kogalniceanu, nr. 8 Bl 1, Sc 1, Ap 09" type="text" />
                        </div>
                      </div>
                    </div>
                    <div className="row">
                      ...
                      <div className="col-lg-4">
                        <div className="form-group">
                          ...
                          <input type="number" id="pincode" name="pincode" className="form-control" placeholder="Country"
                  ...
                  <div className="pl-lg-4">
                    <div className="form-group">
                      ...
                      <input type="file" class="form-control-file" name="file" id="profileImage"
                       name="profileImage" accept="image/x-png,image/gif,image/jpeg" />
